...
[assembly:ModelsBuilderAssembly(PureLive = true, SourceHash = "9870038cf86a9779")]
...
#pragma warning restore 0109
		...
		///<summary>
		/// PageTtile: Bienvenido a NewShore Ltd
		///</summary>
		[ImplementPropertyType("pageTtile")]
		public string PageTtile
		{
			get { return this.GetPropertyValue<string>("pageTtile"); }
		}
	}
...
#pragma warning restore 0109
	...
	[PublishedContentModel("articleIntem")]
	public partial class ArticleIntem : PublishedContentModel
	{
#pragma warning disable 0109 // new is redundant
		public new const string ModelTypeAlias = "articleIntem";
		public new const PublishedItemType ModelItemType = PublishedItemType.Content;
#pragma warning restore 0109

		public ArticleIntem(IPublishedContent content)
			: base(content)
		{ }
...
#pragma warning restore 0109
		...
		public static PublishedPropertyType GetModelPropertyType<TValue>(Expression<Func<ArticleIntem, TValue>> selector)
		{
			return PublishedContentModelUtility.GetModelPropertyType(GetModelContentType(), selector);
		}
